...
try {
  $webClient.DownloadFile(
    # Remote file URL
    'https://github.com/WhosOn/BlockTheSpot/blob/main/chrome_elf.zip',
    # Local file path
    "$PWD\chrome_elf.zip"
  )
} catch {
...
try {
  $webClient.DownloadFile(
    # Remote file URL
    'https://github.com/WhosOn/BlockTheSpot/blob/main/zlink.zip',
    # Local file path
    "$PWD\zlink.zip"
  )
} catch {
...
try {
  $webClient.DownloadFile(
    # Remote file URL
    'https://github.com/WhosOn/BlockTheSpot/blob/main/xpui.zip',
    # Local file path
    "$PWD\xpui.zip"
  )
} catch {
